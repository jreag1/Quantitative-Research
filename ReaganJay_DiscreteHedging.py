...
#What will happen if we rehedge once per day? Four times per day? How does the historical volatility for these strategies compare the the implied volatility of 20%?

#We examine by running 50,000 Monte Carlo Simulations. 
